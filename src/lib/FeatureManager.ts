 ...
 * This class is used for registering your `Feature`s in your app - `FeatureManager` in turn will call the {@link setup} method in your `Feature`.
 */
export class FeatureManager {
     ...
     * @param feature - the {@link Feaure} to register
     */
